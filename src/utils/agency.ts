export function getAgencyIcon(agencyName: string): string {
    switch (agencyName) {
      ...
      case 'Red de Transporte de Pasajeros, Servicio Ordinario':
        return '/icons/rtp.svg'
      case 'Red de Transporte de Pasajeros, Servicio Expreso':
        return '/icons/rtp.svg';
      case 'Red de Transporte de Pasajeros, Servicio Ecobús':
      return '/icons/rtp.svg';
        case 'Red de Transporte de Pasajeros, Servicio Nochebús':
      return '/icons/rtp.svg';
